"""
Script to replace the upload_from_url function in views.py
"""
...
new_lines = lines[:140] + [new_function + '\n'] + lines[182:]

with open('app/views.py', 'w', encoding='utf-8') as f:
    f.writelines(new_lines)

print("✓ Successfully replaced upload_from_url function!")
print(f"  Old function: lines 141-182 (42 lines)")
print(f"  New function: Enhanced with internal share link detection")
